...
// Google Apps Script sends form-encoded data with emailBody (HTML) and emailText (plain)
...
// Step 2: Strip HTML for text analysis â also use plain text from GAS if HTML parse fails
...
const allUrls = [...new Set([...extractAmazonUrls(rawHtml), ...extractAmazonUrls(plainText), ...extractAmazonUrls(emailText)])];
