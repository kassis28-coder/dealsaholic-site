...
export default async function handler(req, context) {
  ...
  <body><header class="header"><div class="header-inner"><a class="logo" href="/">Deals-<span>aholic</span></a><nav aria-label="Main navigation"><a href="/amazon-deals">Amazon</a><a href="/walmart-deals">Walmart</a><a href="/promo-codes">Promo Codes</a><a href="/telegram-deals">Telegram</a><a href="/deals/electronics">Electronics</a><a href="/deals/home">Home</a></nav></div></header>
