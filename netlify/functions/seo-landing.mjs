...
export default async function handler(req, context) {
  ...
  <section class="hero"><div class="hero-inner"><div class="kicker">${esc(landing.kicker)}</div><h1>${esc(landing.heading)}</h1><p>${esc(landing.description)}</p>${landing.channelUrl ? `<a class="channel-cta" href="${esc(landing.channelUrl)}" target="_blank" rel="noopener">Join the Telegram channel →</a>` : ""}</div></section>
