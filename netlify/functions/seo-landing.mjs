...
export default async function handler(req, context) {
  ...
  const matchingDeals = (feed.deals || []).filter(isSeoEligible).filter(landing.filter);
  const deals = matchingDeals.slice(0, 60);
